...
function BookingForm() {
    ...
    const handleBook = async () => {
        ...
        setErrorMsg(null);
        try {
            // Reconstruct the exact selected time
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12">
            <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 border border-gray-100">
                <h2 className="text-3xl font-bold text-gray-900 mb-8 border-b pb-6">Book Appointment</h2>

                {errorMsg && (
                    <div className="bg-red-50 text-red-600 border border-red-200 p-4 rounded-xl mb-8 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4 bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="h-32 overflow-y-auto custom-scrollbar border border-gray-100 rounded-xl relative snap-y snap-mandatory select-none">
                                    <div className="py-12 pointer-events-none"></div> {/* padding for center scrolling */}
